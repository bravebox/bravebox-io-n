    ...
    <main className="page-grid">
      ...
      <div className="page-grid-item is-text">
        <PageArticle className="u-text-align--l">
          <PageLeader>
            My name is Mick schouten and I am a <i>creative front-end developer.</i>
          </PageLeader>
          ...
          <div>
            <PageSubTitle>What is my focus</PageSubTitle>
            <div className="page-focus-container">
              ...
              <PageFocusBox>
                ...
                <PageFocusBoxItem>HTML/CSS (Postcss/SCSS) and Javascript</PageFocusBoxItem>
                <PageFocusBoxItem>W3C Web Components with Polymer</PageFocusBoxItem>
                <PageFocusBoxItem>Vue</PageFocusBoxItem>
                <PageFocusBoxItem>React (basics)</PageFocusBoxItem>
              </PageFocusBox>
            </div>
          </div>
          ...
          <div>
            <PageSubTitle>Bravebox, 2015 and onwards</PageSubTitle>
            <div className="page-focus-container2">
              ...
              <PageFocusBox>
                ...
                <PageFocusBoxItem>2015 ~ ING Wholesale banking (<a href="https://www.ingwb.com" target="_blank" rel="noopener noreferrer">www</a>)</PageFocusBoxItem>
